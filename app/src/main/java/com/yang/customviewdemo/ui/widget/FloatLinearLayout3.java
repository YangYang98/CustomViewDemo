 ...
 */
public class FloatLinearLayout3 extends LinearLayout {
    int currentOffset;
    private AppBarLayout.OnOffsetChangedListener onOffsetChangedListener;

    public FloatLinearLayout3(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    ...
    protected void onAttachedToWindow() {
        ...
        if (parent instanceof AppBarLayout) {
            ...
            if (onOffsetChangedListener == null) {
                onOffsetChangedListener = new FloatLinearLayout3.OffsetUpdateListener();
            }
    ...
    public static class LayoutParams extends LinearLayout.LayoutParams {
        ...
        public LayoutParams(Context c, AttributeSet attrs) {
            super(c, attrs);
            TypedArray a = c.obtainStyledAttributes(attrs, R.styleable.FloatLinearLayout);
            pin =
                    a.getBoolean(
                            R.styleable.FloatLinearLayout_layout_pin, false);
            a.recycle();
        }
    ...
    private class OffsetUpdateListener implements com.google.android.material.appbar.AppBarLayout.OnOffsetChangedListener {
        ...
        public void onOffsetChanged(AppBarLayout layout, int verticalOffset) {
            ...
            for (int i = 0, z = getChildCount(); i < z; i++) {
                ...
                final FloatLinearLayout3.LayoutParams lp = (FloatLinearLayout3.LayoutParams) child.getLayoutParams();
